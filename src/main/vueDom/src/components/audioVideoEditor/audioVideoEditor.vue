<template>
  <div id="audio-video-editor">
    ...
    >
      ...
      <el-table-column prop="stimulateContentUrl" label="实验刺激(音视频版)" header-align="center" align="left" width="180" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column prop="presentDuration" label="呈现时长" header-align="center" align="center" width="180" show-overflow-tooltip>
        <template slot-scope="scope">
          ...
          <span v-else>{{scope.row.leastDuration}}~{{scope.row.leastDuration}}</span>
        </template>
      </el-table-column>
    ...
    <div class="dialog-webkit" v-if="dialogVisible">
      <el-dialog
        ...
        <addRow :row-data="rowData" :disabled="disabled" stimulate-type="AUDIO_AND_VIDEO" @row-data-change="rowDataChange" @close-change="dialogVisible = false" />
