<template>
  <div id="text-editor">
    ...
    >
      ...
      <el-table-column prop="stimulateContentName" label="实验刺激(文字版)" header-align="center" align="left" width="180" show-overflow-tooltip></el-table-column>
    ...
    <div class="dialog-webkit" v-if="dialogVisible">
      <el-dialog
        ...
        <addRow :row-data="rowData" :disabled="disabled" stimulate-type="TEXT" @row-data-change="rowDataChange" @close-change="dialogVisible = false" />
